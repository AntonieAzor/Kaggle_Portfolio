...
The aim of the project is not to produce advanced modelling, but to demonstrate a clear, structured approach to:
...
Applying aggregate functions such as COUNT, AVG, and SUM
...
Public open data (London Cycle Hire dataset)
...
How does ride duration vary by year?

What patterns can be seen when grouping rides over time?

How can aggregation help summarise large volumes of data meaningfully?
...
Filtered data to focus on specific time periods

Grouped data to identify trends and averages

Interpreted results carefully, noting assumptions and limitations
...
More complex joins with related datasets

Clearer visual summaries of results
